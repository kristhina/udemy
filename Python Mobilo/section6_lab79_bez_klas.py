...
cake_01 = {'taste': 'vanilia', 'glaze': 'chocolade', 'text': 'Happy Birthday', 'weight': 0.7}
cake_02 = {'taste': 'tee', 'glaze': 'lemon', 'text': 'Happy Python Coding', 'weight': 1.3}


def show_cake_info_dict(cake):
    print(cake['taste'], cake['glaze'], cake['text'], cake['weight'])


list_of_cakes = [cake_01, cake_02]

for cake in list_of_cakes:
    show_cake_info_dict(cake)
