...
try:
    ...
    print("Error during downloading the file. The url {} is incorrect".format(url))

except FileNotFoundError:
    print("File cannot be found {}". format(file_path))

except PermissionError:
    print("Problems accessing a file {}".format(file_path))
