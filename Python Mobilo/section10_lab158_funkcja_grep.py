...
try:
    os.mkdir('/home/krysia/kursy/Python Mobilo/helpers/')
except:
    pass

with open('/home/krysia/kursy/Python Mobilo/helpers/pl.txt', 'w') as f:
    f.write('http://www.wykop.pl/\n')
    f.write('http://www.ale-beka-jest-taki-adres.pl/\n')
    f.write('http://www.demotywatory.pl')

with open('/home/krysia/kursy/Python Mobilo/helpers/com.txt', 'w') as f:
    f.write('http://www.realpython.com/\n')
    f.write('http://www.nonexistenturl.com/\n')
    f.write('http://www.stackoverflow.com')

for file in gen_get_files('/home/krysia/kursy/Python Mobilo/helpers'):
