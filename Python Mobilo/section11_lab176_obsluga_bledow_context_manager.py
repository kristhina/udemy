...
with FileFromWeb('https://www.ecb.europa.eu/stats/eurofxref/eurofxref.zip', '/home/krysia/kursy/Python Mobilo/euroxref.zip') as f:
    with zipfile.ZipFile(f.tmp_file, 'r') as z:
        a_file = z.namelist()[0]
        print(a_file)
        os.chdir('/home/krysia/kursy/Python Mobilo/')
